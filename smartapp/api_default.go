...
/*
Execute Execute a third-party SmartApp.
...
*/
func (a *DefaultApiService) Execute(ctx _context.Context, executionRequest ExecutionRequest) (ExecutionResponse, *_nethttp.Response, error) {
	var (
