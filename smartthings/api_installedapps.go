...
/*
CreateInstalledAppEvents Create Installed App events.
...
func (a *InstalledappsApiService) CreateInstalledAppEvents(ctx _context.Context, authorization string, installedAppId string, createInstalledAppEventsRequest CreateInstalledAppEventsRequest) (map[string]interface{}, *_nethttp.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/installedapps/{installedAppId}/events"
	...
	// body params
	localVarPostBody = &createInstalledAppEventsRequest
...
/*
DeleteInstallation Delete an installed app.
...
func (a *InstalledappsApiService) DeleteInstallation(ctx _context.Context, authorization string, installedAppId string) (DeleteInstalledAppResponse, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  DeleteInstalledAppResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/installedapps/{installedAppId}"
	localVarPath = strings.Replace(localVarPath, "{"+"installedAppId"+"}", _neturl.QueryEscape(parameterToString(installedAppId, "")) , -1)
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 200 {
			var v DeleteInstalledAppResponse
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
...
/*
GetInstallation Get an installed app.
...
func (a *InstalledappsApiService) GetInstallation(ctx _context.Context, authorization string, installedAppId string) (InstalledApp, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  InstalledApp
	)
...
/*
GetInstallationConfig Get an installed app configuration.
...
func (a *InstalledappsApiService) GetInstallationConfig(ctx _context.Context, authorization string, installedAppId string, configurationId string) (InstallConfigurationDetail, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  InstallConfigurationDetail
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/installedapps/{installedAppId}/configs/{configurationId}"
	localVarPath = strings.Replace(localVarPath, "{"+"installedAppId"+"}", _neturl.QueryEscape(parameterToString(installedAppId, "")) , -1)
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 200 {
			var v InstallConfigurationDetail
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
...
/*
ListInstallationConfig List an installed app's configurations.
...
func (a *InstalledappsApiService) ListInstallationConfig(ctx _context.Context, authorization string, installedAppId string, localVarOptionals *ListInstallationConfigOpts) (PagedInstallConfigurations, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  PagedInstallConfigurations
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/installedapps/{installedAppId}/configs"
	localVarPath = strings.Replace(localVarPath, "{"+"installedAppId"+"}", _neturl.QueryEscape(parameterToString(installedAppId, "")) , -1)
	...
	if localVarOptionals != nil && localVarOptionals.ConfigurationStatus.IsSet() {
		localVarQueryParams.Add("configurationStatus", parameterToString(localVarOptionals.ConfigurationStatus.Value(), ""))
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 200 {
			var v PagedInstallConfigurations
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
...
/*
ListInstallations List installed apps.
...
func (a *InstalledappsApiService) ListInstallations(ctx _context.Context, authorization string, localVarOptionals *ListInstallationsOpts) (PagedInstalledApps, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  PagedInstalledApps
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/installedapps"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
	...
	if localVarOptionals != nil && localVarOptionals.InstalledAppStatus.IsSet() {
		localVarQueryParams.Add("installedAppStatus", parameterToString(localVarOptionals.InstalledAppStatus.Value(), ""))
	}
	if localVarOptionals != nil && localVarOptionals.InstalledAppType.IsSet() {
		localVarQueryParams.Add("installedAppType", parameterToString(localVarOptionals.InstalledAppType.Value(), ""))
	}
