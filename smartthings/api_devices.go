...
/*
CreateDeviceEvents Create Device Events.
...
func (a *DevicesApiService) CreateDeviceEvents(ctx _context.Context, authorization string, deviceId string, deviceEventRequest DeviceEventsRequest) (map[string]interface{}, *_nethttp.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/devices/{deviceId}/events"
	...
	// body params
	localVarPostBody = &deviceEventRequest
...
/*
ExecuteDeviceCommands Execute commands on device.
...
func (a *DevicesApiService) ExecuteDeviceCommands(ctx _context.Context, authorization string, deviceId string, executeCapabilityCommand DeviceCommandsRequest) (map[string]interface{}, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/devices/{deviceId}/commands"
	localVarPath = strings.Replace(localVarPath, "{"+"deviceId"+"}", _neturl.QueryEscape(parameterToString(deviceId, "")) , -1)
	...
	localVarHeaderParams["Authorization"] = parameterToString(authorization, "")
	// body params
	localVarPostBody = &executeCapabilityCommand
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
/*
GetDevice Get a device's description.
...
/*
GetDeviceComponentStatus Get a device component's status.
...
func (a *DevicesApiService) GetDeviceComponentStatus(ctx _context.Context, authorization string, deviceId string, componentId string) (map[string]map[string]AttributeState, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  map[string]map[string]AttributeState
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/devices/{deviceId}/components/{componentId}/status"
	localVarPath = strings.Replace(localVarPath, "{"+"deviceId"+"}", _neturl.QueryEscape(parameterToString(deviceId, "")) , -1)
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 200 {
			var v map[string]map[string]AttributeState
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
...
/*
GetDeviceStatus Get the full status of a device.
...
func (a *DevicesApiService) GetDeviceStatus(ctx _context.Context, authorization string, deviceId string) (DeviceStatus, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/devices/{deviceId}/status"
	localVarPath = strings.Replace(localVarPath, "{"+"deviceId"+"}", _neturl.QueryEscape(parameterToString(deviceId, "")) , -1)
...
/*
GetDeviceStatusByCapability Get a capability's status.
...
func (a *DevicesApiService) GetDeviceStatusByCapability(ctx _context.Context, authorization string, deviceId string, componentId string, capabilityId string) (map[string]AttributeState, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  map[string]AttributeState
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/devices/{deviceId}/components/{componentId}/capabilities/{capabilityId}/status"
	localVarPath = strings.Replace(localVarPath, "{"+"deviceId"+"}", _neturl.QueryEscape(parameterToString(deviceId, "")) , -1)

	localVarPath = strings.Replace(localVarPath, "{"+"componentId"+"}", _neturl.QueryEscape(parameterToString(componentId, "")) , -1)

	localVarPath = strings.Replace(localVarPath, "{"+"capabilityId"+"}", _neturl.QueryEscape(parameterToString(capabilityId, "")) , -1)
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 200 {
			var v map[string]AttributeState
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
...
func (a *DevicesApiService) GetDevices(ctx _context.Context, authorization string, localVarOptionals *GetDevicesOpts) (PagedDevices, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  PagedDevices
	)
	...
	if localVarOptionals != nil && localVarOptionals.Capability.IsSet() {
		t:=localVarOptionals.Capability.Value()
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				localVarQueryParams.Add("capability", parameterToString(s.Index(i), "multi"))
			}
		} else {
			localVarQueryParams.Add("capability", parameterToString(t, "multi"))
		}
	}
	if localVarOptionals != nil && localVarOptionals.LocationId.IsSet() {
		t:=localVarOptionals.LocationId.Value()
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				localVarQueryParams.Add("locationId", parameterToString(s.Index(i), "multi"))
			}
		} else {
			localVarQueryParams.Add("locationId", parameterToString(t, "multi"))
		}
	}
	if localVarOptionals != nil && localVarOptionals.DeviceId.IsSet() {
		t:=localVarOptionals.DeviceId.Value()
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
	...
	if localVarOptionals != nil && localVarOptionals.CapabilitiesMode.IsSet() {
		localVarQueryParams.Add("capabilitiesMode", parameterToString(localVarOptionals.CapabilitiesMode.Value(), ""))
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
func (a *DevicesApiService) InstallDevice(ctx _context.Context, authorization string, installationRequest DeviceInstallRequest) (Device, *_nethttp.Response, error) {
	...
	localVarHeaderParams["Authorization"] = parameterToString(authorization, "")
	// body params
	localVarPostBody = &installationRequest
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
func (a *DevicesApiService) UpdateDevice(ctx _context.Context, authorization string, deviceId string, updateDeviceRequest UpdateDeviceRequest) (Device, *_nethttp.Response, error) {
	...
	localVarHeaderParams["Authorization"] = parameterToString(authorization, "")
	// body params
	localVarPostBody = &updateDeviceRequest
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
