...
/*
CreateSchedule Save an installed app schedule.
...
func (a *SchedulesApiService) CreateSchedule(ctx _context.Context, installedAppId string, authorization string, localVarOptionals *CreateScheduleOpts) (Schedule, *_nethttp.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/installedapps/{installedAppId}/schedules"
	...
	if localVarOptionals != nil && localVarOptionals.Request.IsSet() {
		localVarOptionalRequest, localVarOptionalRequestok := localVarOptionals.Request.Value().(ScheduleRequest)
		if !localVarOptionalRequestok {
			return localVarReturnValue, nil, reportError("request should be ScheduleRequest")
		}
...
func (a *SchedulesApiService) DeleteSchedule(ctx _context.Context, installedAppId string, scheduleName string, authorization string) (map[string]interface{}, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/installedapps/{installedAppId}/schedules/{scheduleName}"
	localVarPath = strings.Replace(localVarPath, "{"+"installedAppId"+"}", _neturl.QueryEscape(parameterToString(installedAppId, "")) , -1)

	localVarPath = strings.Replace(localVarPath, "{"+"scheduleName"+"}", _neturl.QueryEscape(parameterToString(scheduleName, "")) , -1)
...
/*
DeleteSchedules Delete all of an installed app's schedules.
...
/*
GetSchedule Get an installed app's schedule.
...
/*
GetSchedules List installed app schedules.
...
func (a *SchedulesApiService) GetSchedules(ctx _context.Context, installedAppId string, authorization string) (PagedSchedules, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  PagedSchedules
	)
